...
class AppAssistant(ctk.CTk):
    def __init__(self):
        ...
        self.individus, self.familles = charger_gedcom_maison(CHEMIN_GEDCOM)
        self.filtres_ia = {}
        ...
        self.frame_recherche.grid(row=0, column=0, padx=20, pady=15, sticky="ew")
        ...
        self.frame_tableau.grid(row=2, column=0, padx=20, pady=10, sticky="nsew")
        ...
        self.lbl_status = ctk.CTkLabel(self, text=f"Arbre chargé avec succès : {len(self.individus)} individus.", text_color="gray", font=ctk.CTkFont(size=11))
        self.lbl_status.grid(row=3, column=0, padx=20, pady=5, sticky="w")
        ...
        self.btn_ouvrir_folder.grid(row=3, column=0, padx=20, pady=5, sticky="e")
    ...
    def analyser_demande(self):
        ...
        if ascendance_nom:
            ...
            if len(self.individus_trouves_homonymes) == 0:
                ...
                self.frame_homonymes.grid(row=1, column=0, padx=20, pady=5, sticky="ew")
